...
BLOG_AUTHOR = "Random Dots"  # (translatable)
BLOG_TITLE = "#randomdots"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://randomdots8.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "randomdots8@gmail.com"
...
MOMENTJS_DATE_FORMAT = 'MMMM Do YYYY, h:mm:ss a'
...
IMAGE_FOLDERS = {'images': 'images', 'posts/Web Posts/images':'images'}
...
CONTENT_FOOTER = ''' <div class="container">
        <div class="row">
            ...
            <div class="col-md-4" style="padding-left: 0;">
            <iframe src="https://randomdots8.substack.com/embed" style="max-block-size: 88px;" frameborder="0" scrolling="no" class="centred"></iframe></div>
            <div class="col-md-4" style="text-align: end; align-self: right; padding-right: 0; padding-top: 8px;">
...
MARKDOWN_EXTENSIONS = ['markdown.extensions.fenced_code', 'markdown.extensions.codehilite', 'markdown.extensions.extra', 'markdown_checklist.extension', 'markdown.extensions.toc', 'markdown.extensions.footnotes']
...
#         <input type="text" class="form-control mr-sm-2" id="tipue_search_input" name="q" placeholder="Search" autocomplete="off">
#     </div>
