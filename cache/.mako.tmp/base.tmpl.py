...
_magic_number = 10
_modified_time = 1635796128.2035246
_enable_loop = True
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        __M_writer('\n')
        if show_blog_title:
            __M_writer('            <span id="blog-title"></i>')
            __M_writer(filters.html_escape(str(blog_title)))
            __M_writer('</span>\n')
